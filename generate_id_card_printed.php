...
if (isset($_POST['submit'])) {
    ...
    if ($rows != 0) {
      ...
      echo "<meta http-equiv='refresh' content = '0; url = list_id_card_printed.php'/>";
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0">Form to generate Printed ID Card List</h1>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="generate_id_card_printed.php" name="id_car_check">
                            <div class="card-body">
