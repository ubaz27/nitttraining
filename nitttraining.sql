...
CREATE TABLE `tblstudent` (
  ...
  `course_enrol_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tblstudent` (`id`, `reg_number`, `name`, `phone`, `email`, `agency`, `rank`, `gender`, `course_enrol_id`) VALUES
(1, 'cm/20/00001', 'Zara Buhari', '07037961122', 'zara@gamil.com', '1', 'Asst Director', 'F', 1);
